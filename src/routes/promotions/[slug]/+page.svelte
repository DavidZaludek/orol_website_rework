...
<section class="section" aria-label={data.promotion.title}>
	<div class="flow">
		<div class="flow-row flow-row--head">
			<header class="head-cell" data-reveal {@attach reveal()}>
				<div class="meta">
					<time class="eyebrow" datetime={data.promotion.date}>
		...
		<!-- Promo cover keeps its natural color — no grayscale, no overlay. -->
		<div class="flow-row">
