	...
	<div class="container hero-grid">
		...
		<div class="hero-media">
			<div class="photo-frame">
				...
				<span class="photo-caption">Od základov až po kolaudáciu</span>
			</div>
		</div>
	</div>
</section>
...
<section class="section">
	<div class="container split-grid">
		<div data-reveal {@attach reveal()}>
			<span class="eyebrow">Legislatíva</span>
			<h2 class="section-title section-title--sm">Kedy je stavbyvedúci povinný</h2>
			<p class="split-text">
