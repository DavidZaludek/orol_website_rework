...
<svelte:head>
	<title>Dlažby a betónové tvárnice – Produkty – Stavebniny Orol</title>
	<meta
		name="description"
		content="Zámková dlažba, obrubníky, plotové tvárnice a betónové prvky pre exteriér a záhradnú architektúru."
	/>
</svelte:head>
...
<section class="hero">
	<div class="container">
		...
		<h1>Dlažby a betónové tvárnice</h1>
	</div>
</section>
...
<section class="body-section">
	<div class="container">
		<p class="lead">
			Betónové prvky pre exteriér – od zámkovej dlažby na príjazdové cesty cez obrubníky až po
			plotové systémy. Pomôžeme s výberom farby, formátu aj prislúchajúcich kladiacich materiálov.
		</p>

		<h2>Ponúkame</h2>
		<ul class="bullets">
			<li>Zámková dlažba – rôzne formáty, hrúbky a farby</li>
			<li>Veľkoplošná betónová dlažba pre terasy</li>
			<li>Cestné a parkové obrubníky</li>
			<li>Plotové štiepané tvárnice a stĺpiky</li>
			<li>Palisády, schody a oporné múry</li>
			<li>Drenážne a vsakovacie prvky</li>
		</ul>

		<h2>Naši dodávatelia</h2>
		<p class="suppliers-note">
			Spolupracujeme so slovenskými výrobcami betónových prvkov. Ku všetkým produktom Vám pomôžeme
			zostaviť cenovú ponuku vrátane kladiaceho plánu a doplnkov.
		</p>
		...
		<div class="cta-box">
			<p class="cta-text">Záujem o dlažbu alebo tvárnice?</p>
