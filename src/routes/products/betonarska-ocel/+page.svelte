...
<svelte:head>
	<title>Betonárska oceľ – Produkty – Stavebniny Orol</title>
	<meta
		name="description"
		content="Betonárska výstuž, kari siete, strmienky a viazací drôt pre základy, stropy aj armovanie konštrukcií."
	/>
</svelte:head>
...
<section class="body-section">
	<div class="container">
		...
		<h2>Ponúkame</h2>
		<ul class="bullets">
			<li>Betonárska výstuž v tyčiach (rôzne priemery)</li>
			<li>Kari siete štandardných aj atypických rozmerov</li>
			<li>Strmienky a tvarované prvky</li>
			<li>Viazací drôt a dištančné prvky</li>
			<li>Profily a uholníky</li>
			<li>Strihanie a ohýbanie na mieru (po dohode)</li>
		</ul>

		<h2>Naši dodávatelia</h2>
		<p class="suppliers-note">
			Betonársku oceľ odoberáme od overených hutníckych dodávateľov. Ku každej zákazke dodáme
			certifikát kvality a atestačný list.
		</p>
		...
		<div class="cta-box">
			<p class="cta-text">Záujem o betonársku oceľ?</p>
