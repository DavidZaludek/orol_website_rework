...
<svelte:head>
	<title>Hydroizolácia – Produkty – Stavebniny Orol</title>
	<meta
		name="description"
		content="Asfaltové pásy, fólie a tekuté hydroizolácie pre základy, ploché strechy, balkóny a kúpeľne."
	/>
</svelte:head>
...
<section class="body-section">
	<div class="container">
		<p class="lead">
			Hydroizolačné materiály pre celú stavbu – od základov po strechu. Vyberieme vhodné riešenie
			podľa typu konštrukcie, namáhania vodou aj dostupnosti pre svojpomocnú realizáciu.
		</p>

		<h2>Ponúkame</h2>
		<ul class="bullets">
			<li>Asfaltové modifikované pásy (SBS, APP)</li>
			<li>Hydroizolačné PVC a TPO fólie</li>
			<li>Tekuté hydroizolácie a stierkové izolácie</li>
			<li>Penetračné asfaltové nátery</li>
			<li>Bentonitové izolácie a doplnky</li>
			<li>Hydroizolačné systémy pod obklady a dlažby v kúpeľniach</li>
		</ul>

		<h2>Naši dodávatelia</h2>
		<p class="suppliers-note">
			Skladom držíme hydroizolácie od renomovaných výrobcov. Konkrétne značky a typy pásov či fólií
			Vám radi odporučíme podľa konštrukcie a namáhania.
		</p>
		...
		<div class="cta-box">
			<p class="cta-text">Záujem o hydroizoláciu?</p>
