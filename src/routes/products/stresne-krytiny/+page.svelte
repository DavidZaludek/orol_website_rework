...
<svelte:head>
	<title>Strešné krytiny – Produkty – Stavebniny Orol</title>
	<meta
		name="description"
		content="Pálené aj betónové škridly, plechové krytiny, asfaltové šindle, žľaby a kompletný systém klampiarskych doplnkov."
	/>
</svelte:head>
...
<section class="body-section">
	<div class="container">
		...
		<h2>Ponúkame</h2>
		<ul class="bullets">
			<li>Pálené a betónové škridly</li>
			<li>Plechové strešné krytiny – poplastované, hliníkové, falcované</li>
			<li>Asfaltové šindle a pásy</li>
			<li>Strešné okná a svetlíky</li>
			<li>Žľaby, zvody a klampiarske prvky</li>
			<li>Strešné doplnky – snehové zábrany, lemovania, prestupy</li>
		</ul>
