...
<svelte:head>
	<title>Kanalizácia, voda a sanita – Produkty – Stavebniny Orol</title>
	<meta
		name="description"
		content="Rúry a tvarovky pre kanalizáciu a vodovod, šachty, žumpy a sanitárne vybavenie kúpeľne."
	/>
</svelte:head>
...
<section class="hero">
	<div class="container">
		...
		<h1>Kanalizácia, voda a sanita</h1>
	</div>
</section>
...
<section class="body-section">
	<div class="container">
		<p class="lead">
			Kompletný materiál pre vnútorné aj vonkajšie rozvody vody a kanalizácie. Pomôžeme s výberom
			systému od prípojky až po sanitu v kúpeľni, vrátane revíznych šácht a žúmp.
		</p>

		<h2>Ponúkame</h2>
		<ul class="bullets">
			<li>Kanalizačné rúry a tvarovky (PVC, KG, HT)</li>
			<li>Vodovodné rúry a tvarovky (PPR, PEX, meď)</li>
			<li>Revízne šachty, žumpy a vsakovacie nádrže</li>
			<li>Záhradné hadice, postrekovače a rozvody úžitkovej vody</li>
			<li>Sanitárna keramika – WC, umývadlá, sprchové vaničky</li>
			<li>Vodovodné batérie, sifóny a doplnky</li>
		</ul>

		<h2>Naši dodávatelia</h2>
		<p class="suppliers-note">
			Spolupracujeme s overenými výrobcami inštalačných systémov a sanitárnej techniky. Konkrétne
			značky a typy Vám radi navrhneme podľa projektu a požadovaného komfortu.
		</p>
		...
		<div class="cta-box">
			<p class="cta-text">Záujem o inštalačný materiál?</p>
