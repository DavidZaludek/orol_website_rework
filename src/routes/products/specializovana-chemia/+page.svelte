...
<section class="body-section">
	<div class="container">
		...
		<h2>Ponúkame</h2>
		<ul class="bullets">
			<li>PU peny – pištoľové aj trubičkové, montážne aj nízkoexpanzné</li>
			<li>Silikónové, akrylové a hybridné tmely</li>
			<li>Konštrukčné a montážne lepidlá</li>
			<li>Prípravky proti plesniam, riasam a vlhkosti</li>
			<li>Odformovacie prípravky a prísady do betónu</li>
			<li>Antikorózne nátery a chemické kotvy</li>
		</ul>
