...
<svelte:head>
	<title>Objednávkový formulár – Stavebniny Orol</title>
	<meta
		name="description"
		content="Objednajte si stavebný materiál priamo cez online formulár – pripravíme Vám tovar a dohodneme dodanie alebo odber."
	/>
</svelte:head>

<section class="section" aria-label="Objednávkový formulár">
	<div class="comp">
		<div class="comp-row comp-row--head">
			<header class="head-cell" data-reveal {@attach reveal()}>
				<span class="eyebrow">Služby</span>
				<h1 class="section-title">Objednávkový formulár</h1>
				<p class="head-note">
					Vyplňte stručný formulár a my Vám pripravíme objednávku a ozveme sa s potvrdením a
					termínom dodania. Polia označené hviezdičkou sú povinné.
				</p>
			</header>
			...
			<div class="form-cell">
				{#if form?.success}
					<div class="success" role="status" aria-live="polite">
						...
						<p>
							Objednávku sme prijali a čoskoro Vás budeme kontaktovať s potvrdením a termínom
							dodania. V naliehavých prípadoch nám zavolajte na <a
								href={contact.phoneHref}
								rel="external">{contact.phone}</a
							>.
						</p>
					...
					>
						...
						<div class="field">
							<label for="description">
								Stručný popis objednávky <span class="req" aria-hidden="true">*</span>
							</label>
							<textarea
								id="description"
								name="description"
