...
<section class="hero">
	<div class="container">
		...
		<p class="hero-lead">
			Vyplňte stručný formulár a my Vám pripravíme objednávku a ozveme sa s potvrdením a termínom
			dodania. Polia označené hviezdičkou sú povinné.
		</p>
	</div>
</section>
	...
	<div class="container">
		{#if form?.success}
			<div class="success" role="status" aria-live="polite">
				...
				<p>
					Objednávku sme prijali a čoskoro Vás budeme kontaktovať s potvrdením a termínom dodania. V
					naliehavých prípadoch nám zavolajte na <a href={contact.phoneHref}>{contact.phone}</a>.
				</p>
